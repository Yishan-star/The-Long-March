...
const Level1XiangRiver: React.FC<LevelProps> = ({ resources, onUpdateResources, onComplete, onFail, onAction }) => {
  ...
  const handleChoice = (type: 'fight' | 'retreat' | 'hide') => {
    ...
    // [AI-新增] 关卡动作事件上报，用于质量评估与项目管理看板
    onAction?.({
      levelId: 1,
      actionType: type,
      actionLabel: actionLabelMap[type],
      success: !eventHappened,
      progressGain,
      resourceDelta: {
